...
k_means_model = KMeans(n_clusters=5, max_iter=200, random_state=True, n_init=50).fit(
...
def clusterization():
    ...
    :return:
    """
    positive_cluster_index = 3
    negative_cluster_index = [4, 9]
    ...
    words_clusters['cluster_value'] = [1 if i == positive_cluster_index else 0 for i in words_clusters.cluster]
    words_clusters['cluster_value'] = [-1 if i in negative_cluster_index else 0 for i in words_clusters.cluster]
